        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_Documents_SourceDocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceChunkIdsJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxTotalScore = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptIndex = table.Column<int>(type: "integer", nullable: false),
                    Content = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionOptions_QuestionId_OptIndex",
                table: "QuestionOptions",
                columns: new[] { "QuestionId", "OptIndex" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Questions_QuizId_Seq",
                table: "Questions",
                columns: new[] { "QuizId", "Seq" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quizzes_SourceDocumentId",
                table: "Quizzes",
